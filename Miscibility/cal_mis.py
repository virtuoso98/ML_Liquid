...
def miscible_map_v1 (va, ya, substance, index): #index is related to .csv file
    ...
    with open ('data.csv', 'r', encoding = "unicode-escape") as csv_file:
        ...
        for line in csv_reader:
            if line[index] == '1':
                real_xmis.append(float(line[2]))
                real_ymis.append(float(line[1]))
            elif line[index] == '0':
                real_ximmis.append(float(line[2]))
...
miscible_map_v1 (30, 29.8, "water", 3)
# miscible_map_v1 (67.23, 14.27, "methanol", 4)
# miscible_map_v1 (134.05, 2.84, "cyclohexane", 5)
